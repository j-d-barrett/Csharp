...
namespace RandomRomanNameGen
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            String[] join = { "a", "e", "i", "o", "u", "er", "av", "mi", "ban", "bat", "lec", "tis", "pu", "uil", "me", "si", "to", "un", "ro", "fid", "re", "so", "id", "il", "on" };
            ...
            int jIndex = rnd.Next(join.Length);
            int sIndex = rnd.Next(suff.Length);

            // Display the result
            Console.WriteLine("Random Roman Name of the Day: ");
            Console.WriteLine("{0}{1}{2}", pre[pIndex], join[jIndex], suff[sIndex]);
            Console.ReadLine();
